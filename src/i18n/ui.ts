...
export const UI = {
	es: {
		...
		terminal: {
			pista: "escribe 'help' y pulsa enter",
			etiqueta: 'Terminal interactivo: escribe un comando',
			noExiste: 'zsh: command not found: {cmd}',
			ayuda: {
				help: 'esta lista',
				whoami: 'quién soy',
				ls: 'mis proyectos',
				cat: 'un proyecto por dentro — cat trimio',
				stack: 'con qué trabajo',
				sol: 'dónde está el sol sobre La Habana',
				cv: 'descargar el CV',
				contacto: 'cómo escribirme',
				tema: 'claro u oscuro',
				clear: 'limpiar la pantalla',
			},
			cvBajando: 'descargando {archivo}…',
			temaCambiado: 'listo',
			usoCat: 'uso: cat <proyecto> — prueba con {lista}',
			sinProyecto: 'no tengo ningún proyecto llamado «{slug}»',
	...
	en: {
		...
		terminal: {
			pista: "type 'help' and hit enter",
			etiqueta: 'Interactive terminal: type a command',
			noExiste: 'zsh: command not found: {cmd}',
			ayuda: {
				help: 'this list',
				whoami: 'who I am',
				ls: 'my projects',
				cat: 'a project up close — cat trimio',
				stack: 'what I work with',
				sun: 'where the sun is over Havana',
				cv: 'download my CV',
				contact: 'how to reach me',
				theme: 'light or dark',
				clear: 'clear the screen',
			},
			cvBajando: 'downloading {archivo}…',
			temaCambiado: 'done',
			usoCat: 'usage: cat <project> — try {lista}',
			sinProyecto: 'no project called "{slug}" here',
